  ...
  <div class="row d-flex align-items-center justify-content-center">
    <div class="col-md-10">
      <div class="card mb-4">
        ...
        <form action="{{ route('purchase.update', $purchase->id) }}" method="POST" enctype="multipart/form-data" class="source-item pt-4 px-0 px-sm-4">
            ...
            <div class="card-body d-flex flex-column justify-content-center align-items-center w-auto">
                ...
                <div class="createpurchase-form-wrap">

                    <div class="w-50 p-input-width">
                          <label for="purchase_no"  class="form-label" >Purchase no *</label>
                          <input type="text" required="required" id="purchase_no" name="purchase_no" readonly value="{{ $purchase->purchase_no }}" class="form-control form-control-lg">
                        @error('purchase_no')
                    ...
                    <div class="mt-2 mb-3 w-50 p-input-width">
                      ...
                      <select name="supplier_name" id="supplier_name" class="form-select form-select-lg">
                          ...
                          @foreach ($suppliers as $supplier)
                              @if ($purchase->supplier_name == $supplier->supplier_name)
                                  <option style="cursor: pointer;" selected value="{{ $supplier->supplier_name }}">{{ $supplier->supplier_name }}</option>
                              @else
                    ...
                    <div class="w-50 p-input-width">
                        <label for="paid_amount"  class="form-label" >Purchase no *</label>
                        <input type="number" required="required" id="paid_amount" name="paid_amount" value="{{ $purchase->paid_amount}}" class="form-control form-control-lg">
            ...
            <div class="table-responsive text-nowrap px-4 py-4">
              ...
              <div class="purchase-table-footer py-4 w-25">
                ...
                <input class="form-control form-control-lg" type="number" name="total_amount" id="total" placeholder="All Total" readonly value="{{ $purchase->total_amount }}">
              </div>
    ...
    <script>
        ...
        function cloneRow(){
            ...
            <tr class="tr">
              ...
              <td class="purchase-table-selection">
                  <div>
                      <select name="unit_id[]" id="unit_${count}" class="form-select body-select-width-3">
              ...
              <td class="dublicate-row-purchase-table-head">
                  <div class="btn btn-danger rounded-full btn-sm" type="button" onclick="removeRow(event)">
                      <i class='bx bx-x bx-sm'></i>
                  </div>
              </td>
