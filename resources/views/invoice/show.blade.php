      ...
      <div class="card invoice-preview-card">
        ...
        <div class="card-body">
          <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column m-sm-3 m-0">
            ...
            <div>
              <h4 class="fw-semibold mb-2">{{ $invoice->invoice_no }}</h4>
              <div class="mb-2 pt-1">
                <span>Date Issues:</span>
                <span class="fw-semibold">{{ $invoice->updated_at }}</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <table class="table m-0" id="mytable">
                  ...
                  <tfoot class="d-flex justify-content-center align-items-center text-end m-auto">
                    <tr>
                      ...
                      <td class="ps-2 py-4">
                        <p class="fw-semibold mb-2 pt-3">{{ $invoice->paid_amount}}</p>
                        <p class="fw-semibold mb-2">{{ $invoice->paid_amount - $invoice->total_amount}}</p>
                        <p class="fw-semibold mb-0 pb-3">{{ $invoice->total_amount }}</p>
                      </td>
