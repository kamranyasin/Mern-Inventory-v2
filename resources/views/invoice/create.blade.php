    ...
    <div class="col-md-10">
      <div class="card mb-4">
        ...
        <h5 class="card-header">Create Invoice</h5>
          ...
          <form action="{{ route('invoice.store') }}" method="POST" enctype="multipart/form-data" class="source-item pt-4 px-0 px-sm-4">
              ...
              <div class="card-body d-flex flex-column justify-content-center align-items-center w-auto">
                  ...
                  <div class="w-50 p-input-width">
                      ...
                      <input type="text" required="required" id="invoice_no" name="invoice_no" readonly value="{{ $invoice_no }}" class="form-control form-control-lg">
    ...
    <script>
        ...
        function cloneRow(){
            ...
            <tr class="tr">
                                <td>
                                    <div class="purchase-table-selection">
                                        <select name="category_id[]" class="category form-select" id="category_${count}">
                                            <option style="cursor: pointer;" selected disabled>Choose Category</option>
                                            @foreach ($categories as $category)
                                                <option style="cursor: pointer;" value="{{ $category->name }}">{{ $category->name }}</option>
                                            @endforeach
                                ...
                                <td>
                                    <div class="purchase-table-selection">
                                        <select name="product_id[]" id="product_${count}" class="product form-select" data-id="${count}">
                                            <option style="cursor: pointer;" selected disabled>Choose Product</option>
                                        </select>
                                ...
                                <td class="purchase-table-input-header">
                                    <div class="purchase-table-input">
                                        <input type="number" placeholder="0000" name="quantity[]" id="quantity_${count}" onkeyup="calculateTotal(event)" class="form-select">
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="purchase-table-input">
                                        <input type="number" placeholder="0000" name="unit_price[]" id="price_${count}" onkeyup="calculateTotal(event)" readonly class="form-select">
                                    </div>
                                </td>

                                <td>
                                    <div class="purchase-table-input">
                                        <input type="number" class="total form-select" readonly  id="total_${count}" placeholder="Total">
                                    </div>
                                </td>
