    ...
    <div class="row d-flex align-items-center justify-content-center">
      <div class="col-md-6">
        <div class="card mb-4">
          ...
          <h5 class="card-header">Create Type</h5>

            <form action="{{ route('customerstypes.store') }}" method="POST" enctype="multipart/form-data" >
                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <input type="text" required="required" id="type_name" name="type_name" class="form-control form-control-lg" placeholder="name *">
                        @error('type_name')
