...
@section('content')
       ...
       <div class="card">
        ...
        <div class="card-header d-flex justify-content-between align-items-center table-header">
          ...
          <a href="{{ route('customerstypes.create') }}" class="btn btn-primary d-flex gap-2 w-25 table-header-button">
                                 ...
                                 <td class="supplier-table-action">
                                    ...
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('customerstypes.edit', $customertype->id) }}">
                                          <i class="bx bx-edit-alt me-1"></i> Edit
                                        </a>

                                        <form action="{{ route('customerstypes.destroy', $customertype->id) }}" method="POST">
                                          @csrf
                                          @method('DELETE')
